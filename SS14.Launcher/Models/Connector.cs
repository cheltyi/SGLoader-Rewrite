...
public class Connector : ReactiveObject
{
    ...
    private void ConfigureMarsey()
    {
        ...
        Dictionary<string, string?> envVars = new Dictionary<string, string?>
        {
            ...
            { "MARSEY_PATCH_SAFETY", $"{_cfg.GetCVar(CVars.PatchSafetyLevel)}" },
            { "MARSEY_PATCH_VALIDATED", _cfg.GetCVar(CVars.PatchValidatedUrl) },
            { "MARSEY_PATCH_REJECTED", _cfg.GetCVar(CVars.PatchRejectedUrl) },
